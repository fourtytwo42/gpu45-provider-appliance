...
runuser -u gpu45-benchmark -- env HOME=/var/lib/gpu45-benchmark XDG_CONFIG_HOME=/var/lib/gpu45-benchmark/.config UV_NO_CONFIG=1 UV_CACHE_DIR="$cache_root/uv" UV_PROJECT_ENVIRONMENT="$harness_root/venvs/tau" "$uv_bin" sync --frozen --python 3.12 --project "$harness_root/sources/tau"
