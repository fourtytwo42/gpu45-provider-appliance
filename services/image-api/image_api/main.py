...
PROFILES = {
    "flux2-klein-4b": {
        ...
        "test_summary": "Pending appliance validation.",
    },
    "sdxl-turbo": {
        "id": "sdxl-turbo",
        "name": "SDXL Turbo",
    ...
    "qwen-image-gguf-q3": {
        ...
        "test_summary": "512 only. Eight steps is a fast preview; 20-50 steps improves detail and follows the base model guidance.",
    },
}
